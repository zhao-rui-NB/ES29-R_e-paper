/**************************************************************************//**
 * @file     usbd.h
 * @brief    M471M/R1/S Timer USBD driver header file
 *
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. M471M/R1/S supports 8 hardware endpoint ID. This parameter could be 0 ~ 7.
  *
  * @return     None
  *
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. M471M/R1/S supports 8 endpoint ID. This parameter could be 0 ~ 7.
  *
