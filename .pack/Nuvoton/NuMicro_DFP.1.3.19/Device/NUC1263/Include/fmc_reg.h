...
typedef struct
{
     ...
     * |        |          |The NuMicro NUC1261 series is equipped with embedded Flash
     ...
     * |        |          |010 = Frequency is less than or equal to 48 MHz.
     * |        |          |Others = Reserved.
     * |        |          |Note: This bit is write-protected. Refer to the SYS_REGLCTL register.
     * @var FMC_T::ISPSTS
     ...
     * |        |          |This bit is set by hardware if all of Flash bits are 1, and clear if Flash bits are not all 1 after u201CRun Flash All-One Verificationu201D complete; this bit can also be cleared by writing 1
     ...
     * |        |          |1 = FMC_MPDAT0 register has been written, and not programmed to Flash complete.
     ...
     * |        |          |1 = FMC_MPDAT1 register has been written, and not programmed to Flash complete.
     ...
     * |        |          |1 = FMC_MPDAT2 register has been written, and not programmed to Flash complete.
     ...
     * |        |          |1 = FMC_MPDAT3 register has been written, and not programmed to Flash complete.
     * @var FMC_T::MPADDR
