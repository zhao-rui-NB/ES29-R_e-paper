 ...
 * $Revision: 6 $
 * $Date: 17/05/04 5:16p $
 * @brief    N32F030 Series Peripheral Access Layer Header File
 *
 * @note
...
/**
  ...
  *
  *
  * This user manual describes the usage of N32F030 Series MCU device driver
  *
  * <b>Disclaimer</b>
  *
...
/**
  * \page pg1 NuMicro N32F030 Series BSP Directory Structure
  * Please refer to Readme.pdf under BSP root directory for the BSP directory structure
  *
  * \page pg2 Revision History
  * Please refer to NuMicro N32F030 Series CMSIS BSP Revision History.pdf under BSP\\Document directory for the BSP Revision History
  *  
*/



#ifndef __N32F030_H__
#define __N32F030_H__
...
#include "system_N32F030.h"        /* N32F030 System                                          */
 ...
 * |        |          |The NuMicroTM N32F030 series supports word program only. ISPADR[1:0] must be kept 00 for ISP operation.
 * @var FMC_T::ISPDAT
